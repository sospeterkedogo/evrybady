/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ae27fed778e60891e1710efeb21e6b2)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	STRIPE_PAYMENT_LINK_URL: "https://buy.stripe.com/7sY8wP2GtdE87zhfpFes000";
	EMAIL_FROM: "Evrybady Digital <hello@evrybady.digital>";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRIPE_PAYMENT_LINK_URL" | "EMAIL_FROM" | "NEXTJS_ENV">> {}
}
