  ...
  return (
    <main className="min-h-screen bg-white text-ink">
      <div className="mx-auto max-w-3xl px-6 py-24 sm:px-8 lg:py-32">
        ...
        <h1 className="mt-4 text-3xl font-semibold text-ink sm:text-4xl">Terms of Service</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-ink-muted">
          <section>
            ...
            <p>
              These Terms of Service (&quot;Terms&quot;) govern your use of the website and services provided by Evrybady Digital Creative Marketing Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;), a company registered in England and Wales (SIC 70229 — Management consultancy activities). By accessing or using our website at evrybady.digital, you agree to be bound by these Terms.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">3. Use of Website</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">5. Client Work & Ownership</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">6. Payment Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">10. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">11. Contact</h2>
            <p>
