...
export async function POST(req: NextRequest) {
  ...
  try {
    await sendEmail({
      to: ['evrybadydigital@gmail.com', 'pete@evrybady.digital'],
      replyTo: toEmail,
      subject: `Discovery brief received: ${serviceLabel}`,
      html: `<h2>New discovery brief</h2><p><strong>Name:</strong> ${finalName}</p><p><strong>Email:</strong> ${finalEmail}</p><p><strong>Phone:</strong> ${cleanPhone}</p><p><strong>Project areas:</strong> ${serviceLabel}</p><p><strong>Project brief:</strong> ${cleanMessage}</p><p><strong>Company:</strong> ${company || 'Not provided'}</p>`,
      text: [
        'New discovery brief',
        '',
        `Name: ${finalName}`,
    ...
    await sendEmail({
      ...
      subject: 'We received your discovery brief',
      html: `<p>Hi ${finalName},</p><p>Thanks for sharing your project brief with Evrybady Digital. We&apos;ll be in touch shortly to arrange your free discovery call.</p><p><strong>Project areas:</strong> ${serviceLabel}</p><p>After the call, we&apos;ll send a tailored proposal. The onboarding fee is only due if you approve the proposal and choose to begin work.</p><p>Track the progress of your request anytime from your client dashboard: <a href="https://evrybady.digital/client">https://evrybady.digital/client</a></p><p>Best regards,<br />Evrybady Digital</p>`,
      text: [
        `Hi ${finalName},`,
        '',
        'Thanks for sharing your project brief with Evrybady Digital.',
        'We will be in touch shortly to arrange your free discovery call.',
        '',
        `Project areas: ${serviceLabel}`,
        'After the call, we will send a tailored proposal. The onboarding fee is only due if you approve the proposal and choose to begin work.',
