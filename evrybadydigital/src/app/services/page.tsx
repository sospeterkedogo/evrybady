      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-8 lg:px-12">
        ...
        <section className="flex min-h-[70vh] items-center py-24 lg:py-32">
          <div className="w-full">
            ...
            {hero && (
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-[#00000040] sm:p-12">
          ...
          <div className="grid gap-8 xl:grid-cols-2">
            {sections
              ...
              .map((section) => (
                <section
                  key={section.id}
                  className="rounded-2xl border border-white/10 bg-[#0a1e0a] p-8 shadow-xl shadow-[#00000030]"
                >
